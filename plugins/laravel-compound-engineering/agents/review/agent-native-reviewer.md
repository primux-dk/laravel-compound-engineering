...
description: "Reviews code to ensure features are agent-native, verifying that any action a user can take an agent can also take, and anything a user can see an agent can see. Use when new features, UI workflows, or agent tools are added or modified."
model: inherit
---
