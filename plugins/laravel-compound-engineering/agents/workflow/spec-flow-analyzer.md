...
description: "Analyzes specifications, plans, and feature descriptions to map all user flows, identify gaps and ambiguities, and surface missing requirements. Use when a spec or feature plan needs thorough flow analysis and completeness validation before implementation."
model: inherit
---
