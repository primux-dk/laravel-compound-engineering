...
description: "Systematically reproduces and validates bug reports to determine whether reported behavior is an actual bug, expected behavior, or user error. Use when a bug report or issue description needs verification before investing in a fix."
model: inherit
---
