...
description: "Verifies that a UI implementation matches its Figma design specifications. Use after HTML/CSS/React components have been created or modified to visually compare the live implementation against the Figma design and provide detailed feedback on discrepancies."
model: inherit
---
