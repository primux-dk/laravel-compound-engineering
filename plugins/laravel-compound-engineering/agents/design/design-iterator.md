...
description: "Systematically refines UI designs through iterative screenshot-analyze-implement cycles. Use proactively when design work isn't coming together on the first attempt -- takes screenshots, analyzes what's not working, implements improvements, and repeats N times to fix issues with colors, layouts, or overall aesthetics."
color: violet
model: inherit
---
