...
description: "Searches institutional learnings in docs/solutions/ for relevant past solutions before implementing features or fixing problems. Use to efficiently surface documented patterns, gotchas, and lessons learned by filtering on frontmatter metadata (tags, category, module, symptoms) to prevent repeated mistakes."
model: haiku
---
...
**component values:**
- laravel_model, laravel_controller, laravel_view, service_object
