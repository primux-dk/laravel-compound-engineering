...
description: "Conducts thorough research on a repository's structure, documentation, conventions, and implementation patterns. Use when you need to analyze architecture files, examine GitHub issue patterns, review contribution guidelines, check for templates, or understand a codebase's conventions before contributing."
model: inherit
---
...
user: "I want to add a new Action class - what patterns does this codebase use?"
