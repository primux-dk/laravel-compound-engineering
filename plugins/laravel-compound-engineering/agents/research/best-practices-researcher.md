...
description: "Researches and synthesizes external best practices, official documentation, community standards, and open source examples for any technology or development practice. Use when you need comprehensive guidance on how to implement features or solve problems according to industry standards."
model: inherit
---

<examples>
<example>
Context: User wants to know the best way to structure GitHub issues for their Laravel project.
user: "I need to create some GitHub issues for our project. Can you research best practices for writing good issues?"
assistant: "I'll use the best-practices-researcher agent to gather comprehensive information about GitHub issue best practices, including examples from successful projects and Laravel-specific conventions."
