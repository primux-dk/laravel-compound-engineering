...
Based on signals from Idea Refinement and findings from Step 1, decide on external research.
...
```php
// app/Actions/User/ProcessUser.php:12
...
3. **Run `/technical_review`** - Technical feedback from code-focused reviewers (Taylor Otwell, Simplicity)
...
Loop back to options after changes until user selects `/workflows:work` or `/technical_review`.
