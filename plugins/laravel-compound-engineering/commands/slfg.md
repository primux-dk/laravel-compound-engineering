...
3. `/laravel-compound-engineering:deepen-plan`
...
6. `/laravel-compound-engineering:test-browser` — spawn as background Task agent

Wait for both to complete before continuing.

## Finalize Phase

7. `/laravel-compound-engineering:resolve_todo_parallel` — resolve any findings from the review
8. `/laravel-compound-engineering:feature-video` — record the final walkthrough and add to PR
